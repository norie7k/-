...
if __name__ == "__main__":
    excel_files = [
        r"E:\项目\玩家社群分析智能体\玩家发言分类（供研发侧）\12232群_空值补齐V2修正_空值补齐V2.xlsx",
        r"E:\项目\玩家社群分析智能体\玩家发言分类（供研发侧）\【地球】_「不想长大测试」_玩家发言分类「2群」_251217~1222(持续更新).xlsx"
        
    ]
    output_path = r"E:\项目\玩家社群分析智能体\玩家发言分类（供研发侧）\【地球】_「不想长大测试」_玩家发言分类「2群」_251217~1223(持续更新).xlsx"
